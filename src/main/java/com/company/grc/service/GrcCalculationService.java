...
public class GrcCalculationService {
    ...
    @Autowired
    public GrcCalculationService(GstFetchService gstFetchService, GrcRuleEngine ruleEngine, GrcScoreRepository grcScoreRepository) {
    ...
    public void recalculateStoredScore(String gstin) {
         ...
         // To stay pure to requirements, the scheduler will call gstFetchService.fetchAndPersist(gstin) first
         // then call this.
